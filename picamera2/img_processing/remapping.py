# Source: https://docs.opencv.org/3.4/d1/da0/tutorial_remap.html
# ou https://github.com/opencv/opencv/blob/3.4/samples/python/tutorial_code/ImgTrans/remap/Remap_Demo.py
# ou C:\Users\guigu\OneDrive\Dev\GitRepositories\opencv-4.x\samples\python\tutorial_code\ImgTrans\remap\Remap_Demo.py
# What does this program do?
#   Loads an image
#   Each second, apply 1 of 4 different remapping processes to the image and display them indefinitely in a window.
#       remapping = vertical flip, horizontal flip, rotation 90 deg de l'image, rotation 270 deg de l'image
#   Wait for the user to exit the program (esc key)

# Testé le 06-11-2025: ok
# Ligne de commande: python remapping.py --input chicky_512.png
